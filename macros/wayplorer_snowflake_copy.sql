{% macro load_wayplorer_silver_poc_from_stage() %}
  ...
  {% do run_query(
    ...
    ") from (" ~
    "select " ~
    "$1:organization_id::string, $1:tenant_name::string, $1:tenant_domain::string, $1:tenant_company_size::string, " ~
    "$1:application_id::string, $1:module_key::string, $1:record_id::string, $1:resolved_record_id::string, " ~
    "$1:resolved_owner_id::string, $1:resolved_team_id::string, $1:resolved_territory_id::string, " ~
    ...
    ") pattern = '.*[.]parquet' on_error = continue"
  ) %}
  ...
  {% do run_query(
    ...
    ") from (" ~
    "select " ~
    "$1:organization_id::string, $1:tenant_name::string, $1:tenant_domain::string, $1:application_id::string, " ~
    "$1:module_key::string, $1:record_id::string, $1:resolved_record_id::string, $1:resolved_owner_id::string, " ~
    "$1:resolved_team_id::string, $1:resolved_territory_id::string, $1:resolved_stage_value::string, " ~
  ...
  {% do run_query(
    ...
    "select " ~
    "$1:organization_id::string, $1:tenant_name::string, $1:tenant_domain::string, $1:tenant_company_size::string, " ~
    "$1:kpi_date::date, $1:pipeline_created_count::number, $1:qualified_lead_count::number, " ~
